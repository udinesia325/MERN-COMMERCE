  ...
  return (
  	<div className="w-[90%] px-4 py-2 mx-auto">
    	...
    	<div className="card w-72 mt-8 shadow-lg py-2 hover:cursor-pointer hover:shadow-2xl">
    		...
    		<p className="ml-2">RP 1,199,000</p>
    		<div className="w-full flex mt-2">
    			<button className="hover:shadow-lg bg-green-400 text-base font-semibold text-white py-1 px-4 rounded-lg block ml-auto mr-2">Beli</button>
